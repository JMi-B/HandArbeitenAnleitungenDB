...
-- ALTER TABLE gegenstand CHANGE ObjektID GegenstandID INT NOT NULL AUTO_INCREMENT, ADD PRIMARY KEY (GegenstandID);

SHOW INDEX FROM gegenstand;
...
/*
-- 1. Primärschlüssel entfernen
ALTER TABLE gegenstand DROP PRIMARY KEY;

-- 2. Spalte umbenennen
ALTER TABLE gegenstand CHANGE ObjektID GegenstandID INT NOT NULL AUTO_INCREMENT;

-- 3. Primärschlüssel wieder setzen
ALTER TABLE gegenstand ADD PRIMARY KEY (GegenstandID);
-*
ALTER TABLE gegenstand CHANGE ObjektID GegenstandID INT NOT NULL AUTO_INCREMENT, ADD PRIMARY KEY (GegenstandID);
